...
//  FBAPIPractice
//
//  Created by Michael Thomas on 7/17/14.
...
NSString *const kCCUserProfileAboutKey          = @"about";
NSString *const kCCUserProfileRelationshipStatusKey = @"relationshipStatus";
NSString *const kCCUserBirthMonth = @"birthMonth";
NSString *const kCCUserBirthDay = @"birthDay";
NSString *const kCCUserBirthYear = @"birthYear";
